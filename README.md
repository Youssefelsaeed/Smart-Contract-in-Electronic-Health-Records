...
🧩 System Architecture
Entities
Administrator – Deploys and manages the smart contract, controls access rights.

Doctor – Authorized by the Admin to record patient data.

Patient – Data subject whose records are stored immutably on the blockchain.
